    			...
    			image: function() {
					...
					var button = ui.button({
						...
						click: function () {
							...
							$.ajax({
								...
								success: function(html) {
									...
									$('#modal-image').delegate('a.thumbnail', 'click', function(e) {
										...
										var href = s3($(this).attr('href'));
										// alert(href);
										$(element).summernote('insertImage', $(this).attr('href'));
										// $(element).summernote('insertImage', href);
							...
							function s3(href) {
								$.ajax({
									url: 'index.php?route=common/filemanager/toS3&filename='+href+'&user_token=' + getURLVar('user_token'),
									dataType: 'data',
									complete: function() {
									},
									success: function(filename) {
										alert(filename);
										// $(element).summernote('insertImage', filename);
									}
								});	
							}
						}
